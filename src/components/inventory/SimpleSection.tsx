        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <FormField
                control={form.control}
                name="monsoonTapeLength"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base font-medium">🎞️ Monsoon Tape Length</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base font-medium">🎞️ Monsoon Tape Quantity</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base font-medium">🧱 Expansion Wall</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
